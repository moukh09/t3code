 ...
 * `~/.copilot/session-state/*\/events.jsonl`) rather than relying on T3 Code's
 ...
 *
 * v5 and v6 only add providers to {@link UsageProviderKind}; v4 Claude/Codex
...
export const UsageProviderKind = Schema.Literals(["claude", "codex", "grok", "githubCopilot"]);
